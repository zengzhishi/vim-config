...
function! <SID>GetDoxMainpage(leading_blank)
	...
	let doc = ""
	let doc = doc.a:leading_blank."/**\n"
	let doc = doc.a:leading_blank."* @mainpage xxx???ܼ?ʹ?÷??? \n"
	let doc = doc.a:leading_blank."* \<h2>????</h2>\n"
	let doc = doc.a:leading_blank."* <p>xxxxxxxxxxx</p>\n"
	let doc = doc.a:leading_blank."* <ol></ol>\n"
	let doc = doc.a:leading_blank."* <h2>ʹ?÷???</h2>\n"
	let doc = doc.a:leading_blank."* <hr>\n"
	let doc = doc.a:leading_blank."* <p>?????뷢??<a href=\"mailto:".<SID>GetEmail()."?subject=[dilib]\">.".<SID>GetEmail()."</a></p>\n"
	let doc = doc. a:leading_blank."*/\n"
	return doc
endfunction
...
function! <SID>InsertHeadFormat()
  ...
  "call append(line('$')-2, "#ifndef <??Ʒ??>_<ģ??>_". s. "")
  "call append(line('$')-2, "#define <??Ʒ??>_<ģ??>_". s. "")
  "call append(line('$')-2, "")
  "call append(line('$')-2, "#endif  //<??Ʒ??>_<ģ??>_". s. "")
  call append(line("$")-2, "#ifndef __".toupper(expand("%:t:r"))."_H_")  
  call append(line("$")-2, "#define __".toupper(expand("%:t:r"))."_H_")
  call append(line('$')-2, "")
  call append(line("$")-2, "#endif //__".toupper(expand("%:t:r"))."_H_")
endfunction
